...
# <img src="/img/mas_logo.png" alt="brain icon" width="48" style={{ verticalAlign: 'middle' }} /> MAS Python SDK 简介

MAS Python SDK 是一套专为外汇与多资产策略交易者设计的轻量级开源函数库。  
...
- 🔗 集成 MAS Web 平台：账户信息、绩效报表一站式展示  

---

## 📊 策略回测与绩效报表功能

MAS SDK 可在回测与实盘交易后，自动生成多种专业级报表，帮助你评估策略质量与风险控制指标：
...
☑️ 所有报表均可在 MAS SDK 查看与下载，或通过 SDK 导出（视方案等级而定）

---

## 🧩 使用 MAS SDK 前的准备事项

1. 注册 MAS 平台账号 [【立即注册↗】](https://mas.mindaismart.com/authentication/sign-up)（免费）  
2. 下载 MAS 软件 [【点我进行下载↗】](https://mindaismart.com/product_lib)，登录后可查看当前方案等级  
3. 安装 MAS SDK 并启动第一个策略项目 
...
| API 使用手册   | 所有 MAS 函数、参数与返回结果一览 |
| 策略开发实例     | RSI、MACD 等策略案例与代码解说 |
| MAS 平台集成流程 | 部署至 MT5 并执行交易策略     |
...
只需输入你的交易逻辑描述，MAS AI 助理即可帮助你：[【了解更多 ↗】](https://mindaismart.com/product_ai)
