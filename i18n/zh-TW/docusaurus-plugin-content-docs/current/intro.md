...
1. 註冊 MasQuant 平台帳號[【立即註冊↗】](https://trade.masquant.com/authentication/sign-up)（免費）
2. 下載 MasQuant 軟體[【點我進行下載↗】](https://masquant.com/product_lib)，登入後可查看目前方案等級
...
只需輸入你的交易邏輯描述，MasQuant AI 策略助理可協助你：[【了解更多 ↗】](https://masquant.com/product_ai)
